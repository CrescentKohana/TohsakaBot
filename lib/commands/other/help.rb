    ...
    module Help
      ...
      command(:help,
        ...
        @sendhelp.send_embed do |embed|
          ...
          embed.url = ""
          embed.description = "_The prefix for all commands is ?_"
          embed.timestamp = Time.now

          embed.image = Discordrb::Webhooks::EmbedImage.new(url: "https://luukuton.fi/i/2018-06/22_1602-4fe170.gif")
          ...
          embed.add_field(name: ":white_small_square: remindme <01y01M01w01d01h01m01s||yyyy-MM-dd_hh:mm:ss> <msg> (R for repeated, >10 minutes)", value: "You can use this to remind yourself when it's time to stop.")
          ...
          embed.add_field(name: ":black_small_square: **Event triggers**", value: "They consist of ayyy, tyllerö, banaanikissa and some hidden ones.")
